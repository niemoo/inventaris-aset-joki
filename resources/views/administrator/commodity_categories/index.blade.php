@extends('layouts.app', ['title' => 'Halaman Jenis Barang', 'section_header' => 'Jenis Barang'])
                ...
                <div class="row">
                    <div class="col-lg-12 px-3 py-3 text-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#addCommodityCategoryModal">
                            Tambah Data
                        </button>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-justified">
                                        <button type="button" data-toggle="modal" data-id="{{ $commodity_category->id }}"
                                            data-target="#editCommodityCategoryModal"
                                            class="btn btn-success btn-sm commodity-edit">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form action="{{ route('admin.jenis-aset.destroy', $commodity_category->id) }}"
                                            method="POST">
                                            @csrf @method('DELETE')
