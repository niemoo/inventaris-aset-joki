                ...
                <div class="row">
                    <div class="col-lg-12 px-3 py-3 text-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#addCommodityLocationModal">
                            Tambah Data
                        </button>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-justified">
                                        <button type="button" data-toggle="modal" data-id="{{ $commodity_location->id }}"
                                            data-target="#editCommodityLocationModal"
                                            class="btn btn-success btn-sm commodity-location-edit">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form action="{{ route('admin.tempat.destroy', $commodity_location->id) }}"
                                            method="POST">
                                            @csrf @method('DELETE')
